...
class QueryUtils {
    ...
    * @param {String} owner the Order issuer
                ...
                if (isHistory && isHistory === true) {
                    ...
                    if (res.value.is_delete) {
                        ...
                        try {
                            ...
                            // report the order states during the asset lifecycle, just for asset history reporting
                            switch (jsonRes.Value.currentState) {
                                case 1:
                                    jsonRes.Value.currentState = 'PLACED';
                                    break;
                                case 2:
                                    jsonRes.Value.currentState = 'CANCELLED';
                                    break;
                                case 3:
                                    jsonRes.Value.currentState = 'PROCESSING';
                                    break;
                                case 4:
                                    jsonRes.Value.currentState = 'SHIPPED';
                                    break;
                                case 5:
